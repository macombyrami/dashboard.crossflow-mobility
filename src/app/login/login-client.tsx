  ...
  return (
    <div className="min-h-screen bg-bg-base flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-8 left-8 flex items-center gap-3 animate-fade-in pointer-events-none select-none z-40">
        <Image src="/logo-crossflow.png" alt="Logo" width={32} height={32} className="w-8 h-8 object-contain" />
        <span className="text-sm font-bold tracking-tight text-text-primary uppercase opacity-90">{appData.name}</span>
      </div>

      {/* Splash Animation Overly */}
      {showSplash && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-bg-base animate-splash-bg">
      ...
      <div className="w-full max-w-[420px] animate-slide-up">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="w-14 h-14 rounded-2xl bg-brand flex items-center justify-center shadow-[0_0_40px_rgba(34,197,94,0.3)] mb-4 overflow-hidden group">
            <Image 
              src="/logo-crossflow.png" 
              alt="Logo" 
              width={56} 
