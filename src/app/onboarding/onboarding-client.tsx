...
const ROLES = [
  { id: 'operator', title: 'Pilote terrain', desc: 'Suivi des zones et des alertes en direct', icon: Activity },
  { id: 'analyst', title: 'Analyste mobilité', desc: 'Études d’impact et scénarios', icon: BarChart3 },
  { id: 'director', title: 'Décideur', desc: 'Vision stratégique et arbitrage', icon: LayoutDashboard },
]
          ...
          {step === 'role' && (
            <div className="animate-slide-up">
              <header className="mb-8">
                ...
                <p className="text-text-secondary">Pour personnaliser votre expérience, quel est votre profil de pilotage ?</p>
              </header>
          ...
          {step === 'city' && (
            <div className="animate-slide-up">
              ...
              <header className="mb-8">
                ...
                <h1 className="heading-1 mb-2">Zone de suivi</h1>
                <p className="text-text-secondary">Quelle zone souhaitez-vous piloter en priorité ?</p>
              </header>
              ...
              <div className="grid grid-cols-2 gap-3">
                {CITIES.map(c => (
                  ...
                  >
                    ...
                    <p className="text-[10px] text-text-muted uppercase tracking-tight">{(c as any).segmentsCount?.toLocaleString() || '---'} segments utiles</p>
                  </button>
                ))}
              </div>
          ...
          {step === 'activation' && (
            <div className="animate-slide-up text-center py-4">
              <header className="mb-10">
                ...
                <h1 className="heading-1 mb-2">Prêt pour le pilotage</h1>
                <p className="text-text-secondary max-w-sm mx-auto">
                  Votre espace de travail pour <strong>{CITIES.find(c => c.id === selectedCity)?.name}</strong> est prêt.
                </p>
              </header>
              ...
              <div className="space-y-4 max-w-sm mx-auto text-left mb-10">
                ...
                <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/5">
                  ...
                  <span className="text-sm font-medium text-white/80">Lecture temps réel activée</span>
                </div>
              </div>
              ...
              >
                {loading ? (
                  ...
                  <>
                    ...
                    <span>Accéder au tableau de pilotage</span>
