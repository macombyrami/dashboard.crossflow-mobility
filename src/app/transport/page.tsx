    ...
    <div className="flex h-screen overflow-hidden bg-bg-base">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6 space-y-5">
          ...
          {/* Status summary — masqué si pas de données pour éviter les "0" trompeurs */}
          {lines.length > 0 && (
                ...
                >
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2.5">
                      <div
                        className="w-9 h-9 rounded-xl flex items-center justify-center text-sm font-black text-bg-base flex-shrink-0"
                    ...
                    {/* Status badge */}
                    <div
                      className="flex items-center gap-1.5 px-2.5 py-1 rounded-full border text-xs font-semibold flex-shrink-0"
