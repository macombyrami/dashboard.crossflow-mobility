...
export default function SolutionSection({ dictionary }: { dictionary: any }) {
  return (
    <section id="solution" className="py-32 relative">
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        >
          ...
          <br />
          <span className="text-primary">{dictionary.title?.split(" ")?.slice(-2)?.join(" ")}</span>
        </motion.h2>
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 p-7">
                  ...
                  <h3 className="text-xl font-bold text-white mb-2.5 tracking-tight">{item.title}</h3>
                  <p className="text-text-muted text-sm leading-relaxed mb-5">{item.desc}</p>
